...
router.get("/", async (req, res) => {
  try {
    ...
    if(!admins){
      res.json({
      status:"400",
      message:"Found admin records FAILED"
    })
    }else{
      res.json({
      status:"200",
      message:"Found admin records SUCCESSFULLY",
      data:admins
    })
    }
  } catch (err) {
...
router.get("/:adminId", async (req, res) => {
  try {
    ...
    const admins = await       
    Employee.findById(req.params.adminId);
    if(!admins){
      res.json({
      status:"400",
      message:"Found admin record FAILED"
    })
    }else{
      res.json({
      status:"200",
      message:"Found admin record SUCCESSFULLY",
      data:admins
    })
    }
  } catch (err) {
...
router.patch("/:adminId", async (req, res) => {
  try {
    ...
    if(!updateAdmin){
      res.json({
      status:"400",
      message:"Update admin record FAILED"
    })
    }else{
      res.json({
      status:"200",
      message:"Update admin record SUCCESSFULLY",
      data:updateAdmin
    })
    }
  } catch (err) {
...
router.delete("/:adminId", async (req, res) => {
  try {
    ...
    if(!deleteAdmin){
      res.json({
      status:"400",
      message:"Delete admin record FAILED"
    })
    }else{
      res.json({
      status:"200",
      message:"Delete admin record SUCCESSFULLY",
      data:deleteAdmin
    })
    }
  } catch (err) {
